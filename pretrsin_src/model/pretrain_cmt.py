...
class GlocalTextPathCMTPreTraining(BertPreTrainedModel):
    ...
    def forward_mlm(
        ...
        txt_labels, compute_loss,traj_objv2_fts, traj_objv2_lens,
        ...
        txt_embeds = self.bert.forward_mlm(
            ...
            traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
            gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts,traj_objv2_fts, traj_objv2_lens,
            act_txt_ids=act_txt_ids, obj_txt_ids=obj_txt_ids, act_txt_lens=act_txt_lens, obj_txt_lens=obj_txt_lens
        )
    ...
    def forward_mrc(
        ...
        _, vp_embeds = self.bert(
            ...
            traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
            gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts,
            return_gmap_embeds=False,traj_objv2_fts=traj_objv2_fts, traj_objv2_lens=traj_objv2_lens,
            act_txt_ids=act_txt_ids, obj_txt_ids=obj_txt_ids, act_txt_lens=act_txt_lens, obj_txt_lens=obj_txt_lens
        )
    ...
    def forward_sap(
        ...
        traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
        gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts,
        gmap_visited_masks, global_act_labels, local_act_labels, compute_loss,traj_objv2_fts, traj_objv2_lens,
        act_txt_ids=None, obj_txt_ids=None, act_txt_lens=None, obj_txt_lens=None
    ):
        ...
        gmap_embeds, vp_embeds = self.bert(
            ...
            traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
            gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts,
            traj_objv2_fts=traj_objv2_fts, traj_objv2_lens=traj_objv2_lens,
            act_txt_ids=act_txt_ids, obj_txt_ids=obj_txt_ids, act_txt_lens=act_txt_lens, obj_txt_lens=obj_txt_lens
        )
    ...
    def forward_og(
        ...
        traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
        gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts,
        obj_labels, compute_loss,traj_objv2_fts, traj_objv2_lens,
        act_txt_ids=None, obj_txt_ids=None, act_txt_lens=None, obj_txt_lens=None
    ):

...
class ReverieTextPathData(object):
    def __init__(
        ...
        cat_file=None,args=None,tok=None,aug_img_db=None
    ):
        self.args = args
        ...
        # print(f"22222222222222222222222222222222222{aug_img_db}")
    ...
    def get_image_feature_from_tsv(self, scan, viewpoint):
        ...
        if key in self._feature_store:
            ...
            print("Image feature file path:", self.img_ft_file)
...
class R2RTextPathData(ReverieTextPathData):
    ...
    def get_scanvp_feature(self, scan, viewpoint, type='hdf5'):
        if self.use_aug_ft: 
            if np.random.rand() > 0.5:
                # print(f"2222222222222222222222222222222222222222useuse_aug_ft")

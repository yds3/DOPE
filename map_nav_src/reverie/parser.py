...
def parse_args():
    ...
    parser.add_argument('--image_dropout_prob',type=float,default=0.3)
    ...
    parser.add_argument('--max_objv2_objects', type=int, default=3)
    ...
    parser.add_argument("--model",type=str,default='reverie') 
